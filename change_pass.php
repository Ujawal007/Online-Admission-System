...
<style>
  ...
  <table width="100%" height="550px" border="0" cellpadding="0" cellspacing="0" style="background-image: linear-gradient(45deg,#334d50,#cbcaa5)">
    ...
    <tr>
      ...
      <form id="signup" action="action.php?pid=6"  method="post" name="form" onsubmit="return validate();" > 
    <h1>Change password</h1>
    <input type="text" placeholder="Enter OTP" required="" name="op">
    <div id='o' class='error'></div>
    <input type="text" placeholder="Enter New Password" required=""  name="np">
    <div id='n' class='error'></div>
    <input type="password" placeholder="Confirm New Password" required="" name="cp">
