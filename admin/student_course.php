...
<?php
	 // their value is assigned in action page using session function
	$cn="";
	$cc="Select Code";
	$cf="";
	$cd="";
	...
	{
		 // here $msg value is assigned in action page and used here
		$cn=$_SESSION['cn'];		
		$cc=$_SESSION['cc'];
		$cf=$_SESSION['cf'];
		$cd=$_SESSION['cd'];
...
.textarea
{
	...
	border-radius:10px;	
          ...
          <table width="100%" border="0" cellspacing="0" cellpadding="0" style="background-image:url(../images/bg2.jpg);background-repeat:no-repeat;background-size:cover;">
            <tr>
              <td height="63" class="main_heading"><img src="../images/courseinfo.gif" width="100%" height="113" /></td>
            </tr>
            <tr>
              <td height="60" align="center" class="msg"></td>
            </tr>
            <tr>
              <td height="450">
              <form method="post" action="action.php?pid=4" name='form'>
              <table width="98%" border="0" cellspacing="0" cellpadding="0" height="450">
                ...
                <tr>
                  ...
                  <td align="center">&nbsp;</td>
                  <td align="left"><input name="Next" type="submit" class="buttonstyle" id="Next" value="Next" /></td>
                  <td align="center">&nbsp;</td>
                </tr>
              </table>
              </form>
