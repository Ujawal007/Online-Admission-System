...
<div class="container">
	<form name="form"  method="post" action="action.php?pid=1" >
	 <table width="98%" border="0" cellspacing="0" cellpadding="0" >
	 	<tr>
	 		<td align="center" style="color:yellow;font-size: 30px;font-weight: 300;">
	 			PROFILE
	 		</td>
	 	</tr>
	 	<tr>
		...
		<div class="col-md-6 col-sm-12">
			...
			<div class="col-md-6 col-sm-12">
				<div class="styled-input"  style="color: yellow;font-size: 18px;">
					Email-id<input type="text" name="email" value="<?php echo $rs[2]; ?>" />
					
				</div>
			</div>
			<div class="col-md-6 col-sm-12">
				<div class="styled-input" style="color:yellow;font-size: 18px;">
					Father's Name<input type="text" name="fname" value="<?php echo $rs[3]; ?>" />
					
				</div>
			</div>
			<div class="col-md-6 col-sm-12">
				<div class="styled-input" style="color:yellow;font-size: 18px;">
					Contact<input type="text" name="cno" value="<?php echo $rs[4]; ?>" />
			...
			<div class="col-xs-12">
				<div class="styled-input wide"  style="color: yellow;font-size: 18px;font-size: 18px;">
					Address<textarea name="add"><?php echo $rs[9]; ?></textarea>
					
				</div>
			</div>
			<div class="col-xs-12">
				<button class="btn-lrg submit-btn" type="submit" name="Modify" id="Modify">Submit</button>
			</div>			
	</div>
</form>
</div>
